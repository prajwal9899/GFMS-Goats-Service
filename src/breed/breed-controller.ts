...
import { breedModel } from "./breed-modal";
...
export class BreedController {
    ...
    create = async (req: Request, res: Response, next: NextFunction) => {
        ...
        const breed: Breed = { ...req.body };
        const newAnimal = await breedModel.create(breed);
    ...
    //     this.logger.info(`Created category`, { id: productId });
